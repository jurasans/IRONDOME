...
public class CityGenerator {
	 final int maxWidth=50;									//MAXIMUM BUILDING SIZES
     final int maxHeight=50;
     
     static Loader load;									//STATIC REFERENCES TO GAME OBJECTS
	 static Random rand = new Random();
	 
	 private  Rectangle[] country; 							//COLLECTION OF TARGETS FOR DRONE STRIKER.
 ...
 * @param size the quantity of building to build for our country.
 */
	 ...
	 * @param cities the collection of the cities for the dronestriker
	 */
	private void populateCountry(Rectangle[] cities) {
		cities[0]= new Rectangle(new Rectangle(randInt(55,xMax-55),randInt(yMax-250,yMax-55),randInt(5,maxWidth),randInt(5,maxHeight)));
     ...
     * @param load the class loading the game engine
     */
